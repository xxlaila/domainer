...
from settings.serializers.cloud_secret import CloudSecretSerializer
...
class CloudSecretViewSet(viewsets.ModelViewSet):

    queryset = Cloud_Secret.objects.all().order_by("-created_time")
    serializer_class = CloudSecretSerializer
