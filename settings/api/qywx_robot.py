...
from settings.serializers.qywx_robot import QywxRobotSerializer
...
class QywxRobotViewSet(viewsets.ModelViewSet):
    queryset = QywxRobot.objects.all().order_by("-created_time")
    serializer_class = QywxRobotSerializer
