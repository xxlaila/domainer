...
@Time    : 2023/1/16 3:49 下午
@Author  : xxlaila
@Software: PyCharm
"""

from settings.models.additive_solution import AdditiveSolution
from settings.serializers.additive_solution import AdditiveSolutionSerializer
...
class AdditiveSolutionViewSet(viewsets.ModelViewSet):
    queryset = AdditiveSolution.objects.all()
    serializer_class = AdditiveSolutionSerializer
