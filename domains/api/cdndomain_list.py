...
@Time    : 2023/6/30 12:28 下午
@Author  : xxlaila
@Software: PyCharm
"""

from rest_framework import permissions
from domains.serializers.cdndomain_list import CdnDomainsListSerializer
...
class CdnDomainsListViewSet(viewsets.ModelViewSet):
    queryset = CdnDomainsList.objects.all().order_by("-update_time")
    serializer_class = CdnDomainsListSerializer
