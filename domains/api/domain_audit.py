...
class DomainAuditViewSet(viewsets.ModelViewSet):
    queryset = DomainAudit.objects.all().order_by("-name")
    serializer_class = DomainAuditSerializer
